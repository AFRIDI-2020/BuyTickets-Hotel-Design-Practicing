...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w500, color: Colors.black),
    bodyMedium: const TextStyle().copyWith(fontSize: 17.0, fontWeight: FontWeight.normal, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w500, color: Colors.white),
    bodyMedium: const TextStyle().copyWith(fontSize: 17.0, fontWeight: FontWeight.normal, color: Colors.white),
